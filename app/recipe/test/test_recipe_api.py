...
class PrivateRecipeAPITest(TestCase):
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        exists_ingredient = create_ingredient(user=self.user, name='Lemon')
        payload = {
        ...
        recipe = recipes[0]
        self.assertEqual(recipe.ingredients.count(), 2)
        self.assertIn(exists_ingredient, recipe.ingredients.all())
        for ingredient in payload['ingredients']:
            exists = recipe.ingredients.filter(
                name=ingredient['name'],
                user=self.user,
    ...
    def test_clear_recipe_ingredients(self):
        ...
        ingredient = create_ingredient(user=self.user, name='Gralic')
        recipe = create_recipe(user=self.user)
    ...
    def test_filter_by_ingredients(self):
        ...
        r2 = create_recipe(user=self.user, title='Chicken Ball')
        in1 = create_ingredient(user=self.user, name='Cheese')
